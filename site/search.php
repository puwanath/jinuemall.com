...
<head>
	...
	<title><?php echo wordvar('Search');?></title>
...
<body>
	...
	<div class="wrap-page">
		...
		<section class="breakcrumb bg-grey">
			<div class="container">
				<h3 class="pull-left"><span><?php echo wordvar('Search Keyword');?> : <?php echo $searkeyword;?></span></h3>
		...
		<section class="product-grid">
			<div class="container">
				...
				<div class="grid-cn-1">
					<div class="row">
						<?php
							$product_query=mysqli_query($connect,"SELECT * FROM products WHERE product_name LIKE '%$searkeyword%'  or product_description LIKE '%$searkeyword%' ");
