...
<html>
  <head>
	...
	<script src="<?php echo $site_dir;?>/javascripts/application.js" type="text/javascript"></script>
  ...
  <body class="fourofour">
    ...
    <div class="fourofour-container">
      ...
      <a class="btn btn-lg btn-default-outline" href="<?php echo $site_main;?>"><i class="fa fa-home"></i>Go back to JINUEMALL</a>
    </div>
    <!-- End Login Screen -->
  </body>
</html>