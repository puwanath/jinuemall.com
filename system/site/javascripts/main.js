  ...
  $(document).ready(function() {
    ...
    $("#calendar").fullCalendar({
      ...
      events: [
        ...
        {
          title: "Decello by K.Fueng",
          start: new Date(y, m, 21 , 11 , 0),
          end: new Date(y, m, 21 , 12 , 0),
		  allDay: false,
          className: "label label-danger"
        },
        {
          title: "Toothpaste by K.Noki",
        ...
        {
          title: "Glu Gold by K.Noki",
          start: new Date(y, m, 23 , 11 , 0),
          end: new Date(y, m, 23 , 12 , 0),
		  allDay: false,
          className: "label label-danger"
        },
        {
          title: "OPP by K.Chokchai",
        ...
        {
          title: "OPP by online team",
          start: new Date(y, m, 20 , 14 , 0),
          end: new Date(y, m, 20 , 15 , 0),
		  allDay: false,
          className: "label label-success"
        },
        {
        ...
        {
          title: "OPP by K.Eve",
          start: new Date(y, m, 23 , 14 , 0),
          end: new Date(y, m, 23 , 15 , 0),
		  allDay: false,
          className: "label label-success"
        },
        {
        ...
        {
          title: "Why i join JINUE opp by K.Chokchai",
        ...
        },
        {
          ...
          end: new Date(y, m, 20 , 17 , 0),
		  allDay: false,
          className: "label label-danger"
        },
        {
          title: "Goal settiing by K.Chokchai",
          start: new Date(y, m, 21 , 16 , 0),
          end: new Date(y, m, 21 , 17 , 0),
		  allDay: false,
          className: "label label-success"
        },
        {
          title: "Leadership training by K.Eve",
          start: new Date(y, m, 22 , 16 , 0),
          end: new Date(y, m, 22 , 17 , 0),
		  allDay: false,
          className: "label label-success"
        },
        {
          title: "OPP by K.Eve",
          start: new Date(y, m, 23 , 16 , 0),
          end: new Date(y, m, 23 , 17 , 0),
		  allDay: false,
          className: "label label-success"
        },
        {
          ...
          end: new Date(y, m, 24 , 17 , 0),
		  allDay: false,
          className: "label label-success"
        },
		{
          title: "J-System Training",
          start: new Date(y, m, 19 , 18 , 0),
          end: new Date(y, m, 19 , 19 , 0),
		  allDay: false,
          className: "label label-info"
        },
		{
          title: "J-System Training",
          start: new Date(y, m, 23 , 18 , 0),
          end: new Date(y, m, 23 , 19 , 0),
		  allDay: false,
          className: "label label-info"
        },
		{
          title: "J-System Training",
          start: new Date(y, m, 24 , 18 , 0),
          end: new Date(y, m, 24 , 19 , 0),
		  allDay: false,
          className: "label label-info"
        },
		{
          ...
          end: new Date(y, m, 20 , 19 , 0),
		  allDay: false,
          className: "label label-success"
        },
		{
          title: "OPP by online team",
          start: new Date(y, m, 21 , 18 , 0),
          end: new Date(y, m, 21 , 19 , 0),
		  allDay: false,
          className: "label label-success"
        },
		{
          title: "OPP by online team",
          start: new Date(y, m, 22 , 18 , 0),
          end: new Date(y, m, 22 , 19 , 0),
		  allDay: false,
          className: "label label-success"
        }/* ,{
          title: "Long Event",
    ...
    if ($('.typeahead').length) {
      $(".states.typeahead").typeahead({
        name: "states",
        local: ["Kamphaeng Phet","Chiang Rai","Chiang Mai","Tak","Nakhon Sawan","Nan","Phichit","Phitsanulok","Phetchabun","Phrae","Mae Hong Son","Lampang","Lamphun","Sukhothai","Uttaradit","Uthai Thani","Phayao","Bangkok","Kanchanaburi","Chanthaburi","Chachoengsao","Chon Buri","Chai Nat","Trat","Nakhon Nayok","Nakhon Pathom","Nonthaburi","Pathum Thani","Prachuap Khiri Khan","Prachin Buri","Phra Nakhon Si Ayutthaya","Phetchaburi","Rayong","Ratchaburi","Lop Buri","Samut Prakan","Samut Songkhram","Samut Sakhon","Saraburi","Sing Buri","Suphan Buri","Ang Thong","Sa Kaeo","Kalasin","Khon Kaen","Chaiyaphum","Yasothon","Nakhon Phanom","Nakhon Ratchasima","Buri Ram","Maha Sarakham","Roi Et","Loei","Si Sa Ket","Sakon Nakhon","Surin","Nong Khai","Udon Thani","Ubon Ratchathani","Mukdahan","Amnat Charoen","Nong Bua Lam Phu","Krabi","Chumphon","Trang","Nakhon Si Thammarat","Narathiwat","Pattani","Phangnga","Phatthalung","Phuket","Yala","Ranong","Songkhla","Satun","Surat Thani","Bungkan"]
      });
	...
	$("#signup-form").validate({
		  ...
		  messages: {
			signup_name: "Please enter your first name",
			signup_surname: "Please enter your last name",
			signup_username: {
			  required: "Please enter a username",
			  minlength: "Your username must consist of at least 2 characters"
			},
			signup_national_id: {
			  required: "Please enter a National id / Passport",
			  minlength: "Your National id / Passport must consist of at least 13 characters"
			},
			signup_password: {
			  required: "Please provide a password",
			  minlength: "Your password must be at least 5 characters long"
