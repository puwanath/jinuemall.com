...
<head>
    ...
    <![endif]-->
	<?php $actual_link2 = "http://$_SERVER[HTTP_HOST]";?>
	<script type="text/javascript">
	
	/*
	function updateBids() {
		var url= "<?=$site_url;?>/member_online2";
		jQuery("#memberonline").load(url);
		
	}
	setInterval("updateBids()", 6000);
	*/
	</script>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-users"></i> Members Online
                    </header>
					...
					?>
                    <tr>
						<td><img src="<?php echo $site_main;?>/gallery/avatar/<?php echo  $re ->member_avatar;?>" width="35" height="35" alt="avatar member" class="img-circle"></td>
                        ...
                        <td class="hidden-phone"><?php echo selectname('country','country','country_code',$member['country']);?></td>
